...
class MiniUNet(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, **kwargs):
        ...
        self.inv_conv5 = block(128, 128, (3, 1, 1),  stride=(2,1,1),norm_fn=norm_fn, indice_key='spconv5', conv_type='inverseconv')
        ...
        self.inv_conv4 = block(128, 64, 3, stride=(2,1,1), norm_fn=norm_fn, indice_key='spconv4', conv_type='inverseconv')
...
class MiniUNetV1(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, **kwargs):
        ...
        self.conv1 = block(16, 16, 3, norm_fn=norm_fn, padding=1, indice_key='subm1')
